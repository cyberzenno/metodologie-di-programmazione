...
public class ArrayFlessibile {
	 ...
	 * @return
	 */
	public ArrayFlessibile[] splitAt(int x) {
		...
		return new ArrayFlessibile[] { new ArrayFlessibile(left), new ArrayFlessibile(right) };
	}
	 ...
	 * @return
	 */
	public static ArrayFlessibile merge(String[] left, String[] right) {
		...
		return new ArrayFlessibile(merged);
	}
	...
	public static void main(String... args) {
		ArrayFlessibile a = new ArrayFlessibile("A", "B", "C", "D");
		...
		// 2. merge
		a = ArrayFlessibile.merge(x[0].getArray(), x[1].getArray());
		a.stampa();
